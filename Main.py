...
def top():
    ...
    choice5 = Radiobutton(top, text='pc_crash_on_death', value=5, variable=v, command=pc_crash_on_death)
...
char1 = pygame.image.load('player\Player-main.png').convert_alpha()
char = pygame.transform.scale(char1, (50, 50))
astro1 = pygame.image.load('astros/astro1.png').convert_alpha()
astro2 = pygame.image.load('astros/astro2.png').convert_alpha()
astro3 = pygame.image.load('astros/astro3.png').convert_alpha()
astro4 = pygame.image.load('astros/astro4.png').convert_alpha()
astro5 = pygame.image.load('astros/astro5.png').convert_alpha()
astro6 = pygame.image.load('astros/astro6.png').convert_alpha()
astro7 = pygame.image.load('astros/astro7.png').convert_alpha()
astro8 = pygame.image.load('astros/astro8.png').convert_alpha()
astro9 = pygame.image.load('astros/astro9.png').convert_alpha()
astro10 = pygame.image.load('astros/astro10.png').convert_alpha()
astro11 = pygame.image.load('astros/astro11.png').convert_alpha()
astro12 = pygame.image.load('astros/astro12.png').convert_alpha()
astro13 = pygame.image.load('astros/astro13.png').convert_alpha()
astro14 = pygame.image.load('astros/astro14.png').convert_alpha()
astro15 = pygame.image.load('astros/astro15.png').convert_alpha()
astro16 = pygame.image.load('astros/astro16.png').convert_alpha()
